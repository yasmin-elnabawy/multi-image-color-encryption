...
def Dediffuse_img(original_img ,key_stream_diffusionR):
...
def Descramble_img(original_img, key_stream_scramblingR):
...
#     print(red_img1.shape)
    for i in reversed(range(M*N*dimension)):
        t = red_img1[i];
